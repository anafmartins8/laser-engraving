...
export function drawSquareMove(p5, line, topx, tow, wcontainer) {
  p5.fill(255);
...
export function squareMargin(p5, line) {
  return (
    p5.pmouseX > line.y - 10 &&
    p5.pmouseX < line.y + 10 &&
...
export function fillRect(p5, line, topx, tow, yFirstLine) {
  p5.strokeWeight(0);
